...
Requires the Python `attenu-guard` package (and `cryptography`, for the Ed25519 anchor)
importable in the running interpreter. Deterministic: the Ed25519 key, the HMAC secret
